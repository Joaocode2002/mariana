...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Zona Segura de Manobra" },
      {
        name: "description",
        content:
          "Sistema de validação de manobras ferroviárias com checklists de segurança e parada de emergência.",
      },
...
function RootComponent() {
  ...
  const showHeader = ["/painel", "/manobra", "/historico"].some((p) =>
